...
.PHONY: run
run:
	substreams run -e eos.substreams.pinax.network:443 graph_out -s 386841287 -t 386841288 -o json

.PHONY: gui
gui:
	substreams gui -e eos.substreams.pinax.network:443 graph_out -s 386841287
