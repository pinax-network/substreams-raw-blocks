...
pub fn transactions_keys(_clock: &Clock, hash: &String) -> HashMap<String, String> {
    let mut keys = HashMap::new();
    keys.insert("hash".to_string(), hash.to_string());
    keys
}

pub fn actions_keys(_clock: &Clock, tx_hash: &String, action_ordinal: &u32) -> HashMap<String, String> {
    let mut keys = HashMap::new();
...
pub fn receivers_keys(_clock: &Clock, tx_hash: &String, action_ordinal: &u32, receiver: &String) -> HashMap<String, String> {
    let mut keys = HashMap::new();
    keys.insert("tx_hash".to_string(), tx_hash.to_string());
    keys.insert("action_ordinal".to_string(), action_ordinal.to_string());
...
pub fn authorizations_keys(_clock: &Clock, tx_hash: &String, action_ordinal: &u32, actor: &String, permission: &String) -> HashMap<String, String> {
    let mut keys = HashMap::new();
