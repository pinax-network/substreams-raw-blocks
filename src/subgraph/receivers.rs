...
use crate::{keys::receiver_key, utils::is_match};
...
pub fn insert_receiver(params: &String, tables: &mut Tables, transaction: &TransactionTrace, receiver: &String) {
    // transaction
    ...
    if is_match("table:Receiver", params) {
        tables
